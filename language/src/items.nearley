#https://github.com/ghys/openhab-ui-f7/blob/master/src/assets/items-lexer.nearley
@{%
...
AggArgs -> null										{% (d) => undefined %}
	...
	| "(" %number _ "," _ %number ")"				{% (d) => [d[1].text, d[5].text] %} #https://www.openhab.org/docs/configuration/items.html#group-type-and-state
